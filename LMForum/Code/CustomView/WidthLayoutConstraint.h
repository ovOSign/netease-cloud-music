...
/**
 注意：xib中使用的约束(LayoutConstraint)是以   宽度   为依据或者是指定2个控件之间的   横向   距离或者是设置控件的   宽和高   为固定值时，可以继承此类
...
@interface WidthLayoutConstraint : NSLayoutConstraint
