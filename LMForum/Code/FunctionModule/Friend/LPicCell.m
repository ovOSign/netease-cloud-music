...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_deleteBtn setImage:[UIImage imageNamed:@"cm2_act_btn_del"] forState:UIControlStateNormal];
        _deleteBtn.frame = CGRectMake(self.tz_width - 27, -8, 36, 36);
