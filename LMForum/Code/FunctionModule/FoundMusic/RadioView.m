...
@interface RadioView()<UITableViewDelegate,UITableViewDataSource>
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        _tableView = [[LTableView alloc] initWithFrame:CGRectMake(cellMargin, 0, self.frame.size.width-cellMargin*2, self.frame.size.height-49) style:UITableViewStylePlain];
