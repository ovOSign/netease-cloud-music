...
- (void)viewDidLoad {
    [super viewDidLoad];
    _tableView = [[LTableView alloc] initWithFrame:CGRectMake(cellMargin, 0, self.view.frame.size.width-cellMargin, self.view.frame.size.height-49) style:UITableViewStylePlain];
